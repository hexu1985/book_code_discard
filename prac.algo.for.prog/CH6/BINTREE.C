 ...
 * red-black, and self-adjusting (splay) trees.
 *
 * Switches:        REDBLACK - Use red-black variant
 *                  SPLAY    - Use splay tree variant
 *                  TEST     - Include a test driver
 *                  ALTDRAW  - Use only standard drawing symbols
